	...
	<script type="text/javascript">
		$(function() {
			$("#btnbcbtj").click(function() {
				$("#demandState").val("保存");
				var cla1=document.getElementById("demandClass3");
				if(cla1.value==""||cla1.value==null)
				{
					cla1.value=document.getElementById("demandClass2").value;
				}
				var cla2=document.getElementById("demandEconomicClass3");
				if(cla2.value==""||cla2.value==null)
				{
					cla2.value=document.getElementById("demandEconomicClass2").value;
				}
			});
...
<body bgcolor="#FFFFFF" onbeforeunload="checkLeave()">
	<center>
		...
		<s:form action="DemandAction-saveE" method="post">
			<s:hidden name="demandState" id="demandState" />
			<s:textfield  name="demandId" id="demandId" type="hidden"></s:textfield>
			<table>
				<tr>
