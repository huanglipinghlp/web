...
namespace Sy5 {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("notemanagementDataSet11")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class notemanagementDataSet11 : global::System.Data.DataSet {
        ...
        public notemanagementDataSet11() {
            this.BeginInit();
            this.InitClass();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected notemanagementDataSet11(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            notemanagementDataSet11 cln = ((notemanagementDataSet11)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "notemanagementDataSet11";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/notemanagementDataSet11.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            notemanagementDataSet11 ds = new notemanagementDataSet11();
        ...
        public partial class GoodsDataTable : global::System.Data.TypedTableBase<GoodsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public GoodsRow AddGoodsRow(string Goods_ID, string Brand_Name, string Goods_Name, string Goods_Colour, string Goods_Size, string Goods_Material, string Goods_Clean, string Goods_Season, string Goods_MadeBy, string Goods_Sum_Number, string Goods_ramarks, string Goods_danjia) {
...
namespace Sy5.notemanagementDataSet11TableAdapters {
    ...
    public partial class GoodsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Goods] WHERE (([Goods_ID] = @Original_Goods_ID) AND ([Brand_Name] = @Original_Brand_Name) AND ([Goods_Name] = @Original_Goods_Name) AND ([Goods_Colour] = @Original_Goods_Colour) AND ([Goods_Size] = @Original_Goods_Size) AND ([Goods_Material] = @Original_Goods_Material) AND ([Goods_Clean] = @Original_Goods_Clean) AND ([Goods_Season] = @Original_Goods_Season) AND ([Goods_MadeBy] = @Original_Goods_MadeBy) AND ((@IsNull_Goods_Sum_Number = 1 AND [Goods_Sum_Number] IS NULL) OR ([Goods_Sum_Number] = @Original_Goods_Sum_Number)) AND ((@IsNull_Goods_ramarks = 1 AND [Goods_ramarks] IS NULL) OR ([Goods_ramarks] = @Original_Goods_ramarks)) AND ((@IsNull_Goods_danjia = 1 AND [Goods_danjia] IS NULL) OR ([Goods_danjia] = @Original_Goods_danjia)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Goods] ([Goods_ID], [Brand_Name], [Goods_Name], [Goods_Colour], [Goods_Size], [Goods_Material], [Goods_Clean], [Goods_Season], [Goods_MadeBy], [Goods_Sum_Number], [Goods_ramarks], [Goods_danjia]) VALUES (@Goods_ID, @Brand_Name, @Goods_Name, @Goods_Colour, @Goods_Size, @Goods_Material, @Goods_Clean, @Goods_Season, @Goods_MadeBy, @Goods_Sum_Number, @Goods_ramarks, @Goods_danjia);
SELECT Goods_ID, Brand_Name, Goods_Name, Goods_Colour, Goods_Size, Goods_Material, Goods_Clean, Goods_Season, Goods_MadeBy, Goods_Sum_Number, Goods_ramarks, Goods_danjia FROM Goods WHERE (Goods_ID = @Goods_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Goods] SET [Goods_ID] = @Goods_ID, [Brand_Name] = @Brand_Name, [Goods_Name] = @Goods_Name, [Goods_Colour] = @Goods_Colour, [Goods_Size] = @Goods_Size, [Goods_Material] = @Goods_Material, [Goods_Clean] = @Goods_Clean, [Goods_Season] = @Goods_Season, [Goods_MadeBy] = @Goods_MadeBy, [Goods_Sum_Number] = @Goods_Sum_Number, [Goods_ramarks] = @Goods_ramarks, [Goods_danjia] = @Goods_danjia WHERE (([Goods_ID] = @Original_Goods_ID) AND ([Brand_Name] = @Original_Brand_Name) AND ([Goods_Name] = @Original_Goods_Name) AND ([Goods_Colour] = @Original_Goods_Colour) AND ([Goods_Size] = @Original_Goods_Size) AND ([Goods_Material] = @Original_Goods_Material) AND ([Goods_Clean] = @Original_Goods_Clean) AND ([Goods_Season] = @Original_Goods_Season) AND ([Goods_MadeBy] = @Original_Goods_MadeBy) AND ((@IsNull_Goods_Sum_Number = 1 AND [Goods_Sum_Number] IS NULL) OR ([Goods_Sum_Number] = @Original_Goods_Sum_Number)) AND ((@IsNull_Goods_ramarks = 1 AND [Goods_ramarks] IS NULL) OR ([Goods_ramarks] = @Original_Goods_ramarks)) AND ((@IsNull_Goods_danjia = 1 AND [Goods_danjia] IS NULL) OR ([Goods_danjia] = @Original_Goods_danjia)));
SELECT Goods_ID, Brand_Name, Goods_Name, Goods_Colour, Goods_Size, Goods_Material, Goods_Clean, Goods_Season, Goods_MadeBy, Goods_Sum_Number, Goods_ramarks, Goods_danjia FROM Goods WHERE (Goods_ID = @Goods_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Goods_ID, Brand_Name, Goods_Name, Goods_Colour, Goods_Size, Goods_Material" +
                ", Goods_Clean, Goods_Season, Goods_MadeBy, Goods_Sum_Number, Goods_ramarks, Good" +
                "s_danjia FROM dbo.Goods";
        ...
        public virtual int Fill(notemanagementDataSet11.GoodsDataTable dataTable) {
        ...
        public virtual notemanagementDataSet11.GoodsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            notemanagementDataSet11.GoodsDataTable dataTable = new notemanagementDataSet11.GoodsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(notemanagementDataSet11.GoodsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(notemanagementDataSet11 dataSet) {
        ...
        public virtual int Delete(string Original_Goods_ID, string Original_Brand_Name, string Original_Goods_Name, string Original_Goods_Colour, string Original_Goods_Size, string Original_Goods_Material, string Original_Goods_Clean, string Original_Goods_Season, string Original_Goods_MadeBy, string Original_Goods_Sum_Number, string Original_Goods_ramarks, string Original_Goods_danjia) {
            ...
            if ((Original_Goods_MadeBy == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((string)(Original_Goods_MadeBy));
            }
            if ((Original_Goods_Sum_Number == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((string)(Original_Goods_Sum_Number));
            }
            if ((Original_Goods_ramarks == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((string)(Original_Goods_ramarks));
            }
            if ((Original_Goods_danjia == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((string)(Original_Goods_danjia));
            }
        ...
        public virtual int Insert(string Goods_ID, string Brand_Name, string Goods_Name, string Goods_Colour, string Goods_Size, string Goods_Material, string Goods_Clean, string Goods_Season, string Goods_MadeBy, string Goods_Sum_Number, string Goods_ramarks, string Goods_danjia) {
            if ((Goods_ID == null)) {
            ...
            if ((Goods_Sum_Number == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(Goods_Sum_Number));
            }
            if ((Goods_ramarks == null)) {
                this.Adapter.InsertCommand.Parameters[10].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[10].Value = ((string)(Goods_ramarks));
            }
            if ((Goods_danjia == null)) {
                this.Adapter.InsertCommand.Parameters[11].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[11].Value = ((string)(Goods_danjia));
            }
        ...
        public virtual int Update(
            ...
            if ((Goods_Sum_Number == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Goods_Sum_Number));
            }
            if ((Goods_ramarks == null)) {
                this.Adapter.UpdateCommand.Parameters[10].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Goods_ramarks));
            }
            if ((Goods_danjia == null)) {
                this.Adapter.UpdateCommand.Parameters[11].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Goods_danjia));
            }
            if ((Original_Goods_ID == null)) {
                throw new global::System.ArgumentNullException("Original_Goods_ID");
            }
            ...
            if ((Original_Goods_MadeBy == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_Goods_MadeBy));
            }
            if ((Original_Goods_Sum_Number == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_Goods_Sum_Number));
            }
            if ((Original_Goods_ramarks == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((string)(Original_Goods_ramarks));
            }
            if ((Original_Goods_danjia == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[26].Value = ((string)(Original_Goods_danjia));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_Goods_ramarks, 
                    string Original_Goods_danjia) {
            return this.Update(Original_Goods_ID, Brand_Name, Goods_Name, Goods_Colour, Goods_Size, Goods_Material, Goods_Clean, Goods_Season, Goods_MadeBy, Goods_Sum_Number, Goods_ramarks, Goods_danjia, Original_Goods_ID, Original_Brand_Name, Original_Goods_Name, Original_Goods_Colour, Original_Goods_Size, Original_Goods_Material, Original_Goods_Clean, Original_Goods_Season, Original_Goods_MadeBy, Original_Goods_Sum_Number, Original_Goods_ramarks, Original_Goods_danjia);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(notemanagementDataSet11 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._goodsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(notemanagementDataSet11 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._goodsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(notemanagementDataSet11 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._goodsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(notemanagementDataSet11 dataSet) {
            if ((dataSet == null)) {
