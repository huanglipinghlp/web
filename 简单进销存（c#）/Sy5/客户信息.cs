...
namespace Sy5
{
    public partial class 客户信息 : Form
    {
        public 客户信息()
        {
            InitializeComponent();
        ...
        private void 客户信息_Load(object sender, EventArgs e)
        {
            // TODO:  这行代码将数据加载到表“notemanagementDataSet1.Client”中。您可以根据需要移动或删除它。
            this.clientTableAdapter.Fill(this.notemanagementDataSet1.Client);
            /**
            * 
            * 以下为自动调整列宽的代码
            * 
