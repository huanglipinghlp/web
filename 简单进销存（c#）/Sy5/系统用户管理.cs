...
namespace Sy5
{
    public partial class 系统用户管理 : Form
    {
        public 系统用户管理()
        {
            InitializeComponent();
        ...
        private void 系统用户管理_Load(object sender, EventArgs e)
        {
            // TODO:  这行代码将数据加载到表“notemanagementDataSet16.LoginUser”中。您可以根据需要移动或删除它。
            this.loginUserTableAdapter.Fill(this.notemanagementDataSet16.LoginUser);
            /**
            * 
            * 以下为自动调整列宽的代码
            * 
